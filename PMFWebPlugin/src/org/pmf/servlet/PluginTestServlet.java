	...
	private void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if (logs != null && !logs.isEmpty()) {
				...
				ClassLoader cl = new URLClassLoader(new URL[] {new URL("file:///"+pluginPath+"/"+pluginContext.get(apiKey).get("jar"))}, this.getClass().getClassLoader());
				Class<?> c = Class.forName(pluginContext.get(apiKey).get("service_class"), true, cl);
